...
![Mountain climbing-1](img/Mountain climbing-1.png)
...
![Mountain climbing-2](img/Mountain climbing-2.png)

![Mountain climbing-3](img/Mountain climbing-3.png)
...
![Mountain climbing-4](img/Mountain climbing-4.png)
...
![Mountain climbing-5](img/Mountain climbing-5.png)

## Step.2 IDA 反编译 + 动态调试

运行程序，需要一个输入，先随便输个数字：

![Mountain climbing-6](img/Mountain climbing-6.png)
...
>
> ![Mountain climbing-7](img/Mountain climbing-7.png)
>
> F8 步过，可以看到代码正常显示！
>
> ![Mountain climbing-8](img/Mountain climbing-8.png)
